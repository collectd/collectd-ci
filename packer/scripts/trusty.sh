...
apt-get -y install autoconf automake bison clang cpp flex gcc gcc-4.4 gcc-4.6 gcc-4.7 gcc-4.8 gdb git libc6-dev libtool m4 make pkg-config strace valgrind
