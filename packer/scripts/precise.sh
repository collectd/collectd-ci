...
apt-get -y install autoconf automake bison clang-3.3 clang-3.4 cpp flex gcc gcc-4.4 gcc-4.5 gdb git libc6-dev libtool m4 make pkg-config strace valgrind
